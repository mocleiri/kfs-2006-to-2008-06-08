...
public class YearEndGeneralErrorCorrectionDocumentTest extends TransactionalDocumentTestBase {
    public static final String COLLECTION_NAME = "YearEndGeneralErrorCorrectionDocumentTest.collection1";
    public static final String USER_NAME = "user1";
    public static final String DOCUMENT_PARAMETER = "yearEndGeneralErrorCorrectionDocumentParameter1";
