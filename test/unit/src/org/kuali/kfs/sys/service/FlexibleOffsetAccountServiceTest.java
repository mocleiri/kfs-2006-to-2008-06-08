...
public class FlexibleOffsetAccountServiceTest extends KualiTestBase {
    ...
    public void testGetByPrimaryId_valid() throws Exception {
        ...
        TestUtils.setSystemParameter(KFSConstants.FINANCIAL_NAMESPACE, KFSConstants.SystemGroupParameterNames.FLEXIBLE_OFFSET_ENABLED_FLAG, "Y", true, false);
    ...
    public void testGetByPrimaryId_validDisabled() throws Exception {
        TestUtils.setSystemParameter(KFSConstants.FINANCIAL_NAMESPACE, KFSConstants.SystemGroupParameterNames.FLEXIBLE_OFFSET_ENABLED_FLAG, "N", false, false);
    ...
    public void testGetByPrimaryId_invalid() throws Exception {
        TestUtils.setSystemParameter(KFSConstants.FINANCIAL_NAMESPACE, KFSConstants.SystemGroupParameterNames.FLEXIBLE_OFFSET_ENABLED_FLAG,"N", true, false);
