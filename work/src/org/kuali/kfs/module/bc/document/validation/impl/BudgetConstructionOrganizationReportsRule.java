    ...
    protected boolean checkSimpleRules(MaintenanceDocument document) {
        ...
        if ( ObjectUtils.isNotNull(newBCOrgReports.getChartOfAccountsCode())
            ...
            if ( ObjectUtils.isNotNull(tempOrg)){
                if (applyApcRule(KFSConstants.CHART_NAMESPACE, KFSConstants.Components.ORGANIZATION_COMPONENT, KFSConstants.ChartApcParms.ORG_MUST_REPORT_TO_SELF_ORG_TYPES, tempOrg.getOrganizationTypeCode())) {
