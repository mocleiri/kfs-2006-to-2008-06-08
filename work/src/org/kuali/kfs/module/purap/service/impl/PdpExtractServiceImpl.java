...
public class PdpExtractServiceImpl implements PdpExtractService {
    ...
    public void extractPayments() {
        ...
        String userId = kualiConfigurationService.getParameterValue(KFSConstants.PURAP_NAMESPACE, PurapParameterConstants.PURAP_PDP_USER_ID);
        UniversalUser uuser;
        try {
    ...
    private Batch createBatch(String campusCode,PdpUser puser,Date processRunDate) {
        String orgCode = kualiConfigurationService.getParameterValue(KFSConstants.PURAP_NAMESPACE, PurapParameterConstants.PURAP_PDP_EPIC_ORG_CODE);
        String subUnitCode = kualiConfigurationService.getParameterValue(KFSConstants.PURAP_NAMESPACE, PurapParameterConstants.PURAP_PDP_EPIC_SBUNT_CODE);
