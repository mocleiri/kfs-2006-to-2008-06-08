...
public class PayeeDocumentAuthorizer extends MaintenanceDocumentAuthorizerBase {
    ...
    public Map getEditMode(Document document, UniversalUser user) {
        ...
        if ( user.isMember( SpringContext.getBean(KualiConfigurationService.class).getParameterValue( KFSConstants.FINANCIAL_NAMESPACE, KFSConstants.FinancialApcParms.DV_TAX_WORKGROUP ) ) ) {
