...
public class DisbursementVoucherDocumentAuthorizer extends AccountingDocumentAuthorizerBase {
    ...
    private boolean isUserInTaxGroup( UniversalUser user ) {
        if ( taxGroupName == null ) {
            taxGroupName = SpringContext.getBean(KualiConfigurationService.class).getParameterValue( KFSConstants.FINANCIAL_NAMESPACE, KFSConstants.FinancialApcParms.DV_TAX_WORKGROUP );
        }
    ...
    private boolean isUserInTravelGroup( UniversalUser user ) {
        if ( travelGroupName == null ) {
            travelGroupName = SpringContext.getBean(KualiConfigurationService.class).getParameterValue( KFSConstants.FINANCIAL_NAMESPACE, KFSConstants.FinancialApcParms.DV_TRAVEL_WORKGROUP );
        }
    ...
    private boolean isUserInFRNGroup( UniversalUser user ) {
        if ( frnGroupName == null ) {
            frnGroupName = SpringContext.getBean(KualiConfigurationService.class).getParameterValue( KFSConstants.FINANCIAL_NAMESPACE, KFSConstants.FinancialApcParms.DV_FOREIGNDRAFT_WORKGROUP );
        }
    ...
    private boolean isUserInWireGroup( UniversalUser user ) {
        if ( wireTransferGroupName == null ) {
            wireTransferGroupName = SpringContext.getBean(KualiConfigurationService.class).getParameterValue( KFSConstants.FINANCIAL_NAMESPACE, KFSConstants.FinancialApcParms.DV_WIRETRANSFER_WORKGROUP );
        }
    ...
    private boolean isUserInDvAdminGroup( UniversalUser user ) {
        if ( adminGroupName == null ) {
            adminGroupName = SpringContext.getBean(KualiConfigurationService.class).getParameterValue( KFSConstants.FINANCIAL_NAMESPACE, KFSConstants.FinancialApcParms.DV_ADMIN_WORKGROUP );
        }
