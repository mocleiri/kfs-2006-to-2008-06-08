...
public class ProcurementCardDocumentRuleConstants {
    ...
    public static final String ACCOUNT_NUMBER_GLOBAL_RESTRICTION_PARM_NM = "ACCOUNT_NUMBER_RESTRICTIONS";
    ...
    public static final String VALID_OBJECTS_BY_MCC_CODE_PARM_NM = "VALID_OBJECTS_BY_MCC_CODE";
    public static final String INVALID_OBJECTS_BY_MCC_CODE_PARM_NM = "INVALID_OBJECTS_BY_MCC_CODE";
    public static final String VALID_OBJ_SUB_TYPE_BY_MCC_CODE_PARM_NM = "VALID_OBJ_SUB_TYPE_BY_MCC_CODE";
    public static final String INVALID_OBJ_SUB_TYPE_BY_MCC_CODE_PARM_NM = "INVALID_OBJ_SUB_TYPE_BY_MCC_CODE";
}
