...
public class SufficientFundsServiceImpl implements SufficientFundsService, SufficientFundsServiceConstants {
    ...
    public boolean checkSufficientFunds(TransactionalDocument transactionalDocument) {
        ...
        if (!StringUtils.equals(Constants.BUDGET_CHECKING_OPTIONS_CD_ACTIVE, retrieveOptions(transactionalDocument.getPostingYear()).getBudgetCheckingOptionsCode())) {
            return true;
        }
    ...
    private boolean checkSufficientFunds(List propertyNames, Integer universityFiscalYear, String chartOfAccountsCode, String accountNumber, String sufficientFundsObjectCode, KualiDecimalMoney amount, Class documentClass) {
        ...
        sfBalances = (SufficientFundBalances) businessObjectService.findByPrimaryKey(SufficientFundBalances.class, persistenceService.getPrimaryKeyFieldValues(sfBalances));
        // fp_sasfc:32-1
        if (sfBalances == null) {
