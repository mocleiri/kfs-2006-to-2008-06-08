...
public class PurgeCollectorDetailStep extends AbstractStep {
    ...
    public boolean execute(String jobName) {
        String yearStr = getConfigurationService().getParameterValue(KFSConstants.GL_NAMESPACE, KFSConstants.SystemGroupParameterNames.PURGE_GL_ID_BILL_T_BEFORE_YEAR);
