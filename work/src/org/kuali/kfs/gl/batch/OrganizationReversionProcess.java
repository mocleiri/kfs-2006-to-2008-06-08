...
public class OrganizationReversionProcess {
    ...
    public OrganizationReversionProcess() {
        ...
        this.ORGANIZATION_REVERSION_COA = kualiConfigurationService.getParameterValues(KFSConstants.GL_NAMESPACE, KFSConstants.Components.ORGANIZATION_REVERSION, GLConstants.OrganizationReversionProcess.ORGANIZATION_REVERSION_COA);
    ...
    public void organizationReversionProcess() {
        ...
        while (balances.hasNext()) {
            ...
            try {
                ...
                balancesSelected += calculateCashAndActualAmounts(bal);
     ...
     * @return
     */
    protected int calculateCashAndActualAmounts(Balance bal) {
        int balancesSelected = 0;
        ...
        return balancesSelected;
    }

    protected int writeActivity(Balance bal) throws FatalErrorException {
    ...
    private int writeCash() throws FatalErrorException {
        ...
        entry.setTransactionLedgerEntryDescription(kualiConfigurationService.getPropertyString(KFSKeyConstants.OrganizationReversionProcess.CASH_REVERTED_TO) + organizationReversion.getCashReversionAccountNumber());
    ...
    protected void calculateTotals(Balance bal) throws FatalErrorException {
    ...
    private void setParameters() {
        // Get job parameters
        String strTransactionDate = kualiConfigurationService.getParameterValue(KFSConstants.GL_NAMESPACE, KFSConstants.Components.BATCH, KFSConstants.TRANSACTION_DT);
        ...
        paramBegBudgetCashObjectCode = kualiConfigurationService.getParameterValue(KFSConstants.GL_NAMESPACE, KFSConstants.Components.BATCH, KFSConstants.BEG_BUD_CASH_OBJECT_CD);
        paramFundBalanceObjectCode = kualiConfigurationService.getParameterValue(KFSConstants.GL_NAMESPACE, KFSConstants.Components.BATCH, KFSConstants.FUND_BAL_OBJECT_CD);
        String strUniversityFiscalYear = kualiConfigurationService.getParameterValue(KFSConstants.GL_NAMESPACE, KFSConstants.Components.BATCH, KFSConstants.UNIV_FISCAL_YR);
