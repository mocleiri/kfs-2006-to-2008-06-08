...
public class PurgeBalanceStep extends AbstractStep {
    ...
    public boolean execute(String jobName) {
        String yearStr = getConfigurationService().getParameterValue(KFSConstants.GL_NAMESPACE, KFSConstants.SystemGroupParameterNames.PURGE_GL_BALANCE_T_BEFORE_YEAR);
