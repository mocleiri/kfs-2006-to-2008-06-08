...
public class EncumbranceClosingRuleHelper {
    ...
    public boolean isEncumbranceEligibleForCostShare(OriginEntry entry, OriginEntry offset, Encumbrance encumbrance, String objectTypeCode) throws FatalErrorException {
        ...
        String[] expenseObjectCodeTypes = kualiConfigurationService.getParameterValues(KFSConstants.GL_NAMESPACE, KFSConstants.Components.ALL, AccountingDocumentRuleBaseConstants.APPLICATION_PARAMETER.EXPENSE_OBJECT_TYPE_CODES);
