...
public class SufficientFundsRebuilderServiceImpl implements SufficientFundsRebuilderService {
    ...
    private Integer getFiscalYear() {
        String val = kualiConfigurationService.getParameterValue(KFSConstants.GL_NAMESPACE, KFSConstants.Components.BATCH, GLConstants.ColumnNames.UNIVERSITY_FISCAL_YEAR);
