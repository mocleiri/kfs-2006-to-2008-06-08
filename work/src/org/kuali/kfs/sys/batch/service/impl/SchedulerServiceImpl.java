...
public class SchedulerServiceImpl implements SchedulerService {
    ...
    private boolean isPastScheduleCutoffTime(Calendar dateTime, boolean log) {
        try {
            ...
            String[] scheduleStepCutoffTime = StringUtils.split(configurationService.getParameterValue(KFSConstants.CORE_NAMESPACE, KFSConstants.SystemGroupParameterNames.BATCH_SCHEDULE_CUTOFF_TIME), ":");
            ...
            if (configurationService.getIndicatorParameter(KFSConstants.CORE_NAMESPACE, KFSConstants.SystemGroupParameterNames.BATCH_SCHEDULE_CUTOFF_TIME_IS_NEXT_DAY)) {
