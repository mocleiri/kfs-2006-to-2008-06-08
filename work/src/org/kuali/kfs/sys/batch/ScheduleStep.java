...
public class ScheduleStep extends AbstractStep {
    ...
    public boolean execute(String jobName) {
        ...
        while (schedulerService.hasIncompleteJob() && !isPastScheduleCutoffTime) {
            ...
            try {
                Thread.sleep(Integer.parseInt(getConfigurationService().getParameterValue(KFSConstants.CORE_NAMESPACE, KFSConstants.SystemGroupParameterNames.BATCH_SCHEDULE_STATUS_CHECK_INTERVAL)));
            }
