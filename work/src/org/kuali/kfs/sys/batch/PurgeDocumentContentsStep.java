...
public class PurgeDocumentContentsStep extends AbstractStep {
    ...
    public boolean execute(String jobName) {
        int numberOfDaysFinal = Integer.parseInt(getConfigurationService().getParameterValue(KFSConstants.FINANCIAL_NAMESPACE, KFSConstants.Components.PURGE_DOCUMENT_CONTENTS_STEP, "NUMBER_OF_DAYS_FINAL"));
