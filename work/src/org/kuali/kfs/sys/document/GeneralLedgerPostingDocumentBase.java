...
public class GeneralLedgerPostingDocumentBase extends LedgerPostingDocumentBase implements GeneralLedgerPostingDocument {
    ...
    public boolean isBankCashOffsetEnabled() {
        return SpringContext.getBean(KualiConfigurationService.class).getIndicatorParameter(KFSConstants.CORE_NAMESPACE, KFSConstants.SystemGroupParameterNames.FLEXIBLE_CLAIM_ON_CASH_BANK_ENABLED_FLAG);
    }
