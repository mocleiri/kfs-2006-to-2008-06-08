...
public class BatchJobStatusLookupableHelperServiceImpl extends KualiLookupableHelperServiceImpl {
    ...
    public String getActionUrls(BusinessObject businessObject) {
        if ( businessObject instanceof BatchJobStatus ) {
            ...
            if ( configService.parameterExists(KFSConstants.CORE_NAMESPACE,KFSConstants.SystemGroupParameterNames.JOB_ADMIN_WORKGROUP) ) {            
                String adminWorkgroup = configService.getParameterValue(KFSConstants.CORE_NAMESPACE, KFSConstants.SystemGroupParameterNames.JOB_ADMIN_WORKGROUP);
