...
public class FiscalYearMakerStep extends AbstractStep {
    ...
    public boolean execute(String jobName) throws InterruptedException {
        dateMakerService.fiscalYearMakers(Integer.parseInt(getConfigurationService().getParameterValue(KFSConstants.CHART_NAMESPACE, KFSConstants.ChartApcParms.FISCAL_YEAR_MAKER_SOURCE_FISCAL_YEAR)), getConfigurationService().getIndicatorParameter(KFSConstants.CHART_NAMESPACE, KFSConstants.ChartApcParms.FISCAL_YEAR_MAKER_REPLACE_MODE));
        return true;
    }
