...
public class OrganizationRoutingModelRule extends MaintenanceDocumentRuleBase {
    ...
    protected boolean checkDelegateUserRules(OrganizationRoutingModel delegateModel) {
        ...
        if (success) {
            ...
            if (apcRuleFails(KFSConstants.CHART_NAMESPACE, KFSConstants.ChartApcParms.DELEGATE_USER_EMP_STATUSES, user.getEmployeeStatusCode())) {
            ...
            if (apcRuleFails(KFSConstants.CHART_NAMESPACE, KFSConstants.ChartApcParms.DELEGATE_USER_EMP_TYPES, user.getEmployeeTypeCode())) {
