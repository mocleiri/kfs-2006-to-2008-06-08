...
public class VendorDocumentAuthorizer extends MaintenanceDocumentAuthorizerBase {
    ...
    public Map getEditMode(Document document, UniversalUser user) {
        ...
        String taxNbrAccessibleWorkgroup = SpringContext.getBean(KualiConfigurationService.class).getParameterValue(KFSConstants.PURAP_NAMESPACE, VendorConstants.Workgroups.WORKGROUP_TAXNBR_ACCESSIBLE );
