            ...
            <table cellpadding="0" cellspacing="0" summary="view/edit document overview information">
              ...
              <tr>
                ...
                <td width="30%" align=left valign=middle >
	    	    	...
	    	    	<c:if test="${!viewOnly and !budgetLinked}">
	    			    <kul:lookup boClassName="org.kuali.module.cg.bo.Agency" fieldConversions="agencyNumber:document.agencyFederalPassThroughNumber,fullName:document.federalPassThroughAgency.fullName" extraButtonSource="${ConfigProperties.kr.externalizable.images.url}buttonsmall_namelater.gif" extraButtonParams="&document.agencyFederalPassThroughNotAvailableIndicator=true" anchor="${currentTabIndex}" />
	    			</c:if>&nbsp;
                </td>
