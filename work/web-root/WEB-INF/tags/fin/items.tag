	...
	<table cellpadding="0" cellspacing="0" class="datatable" summary="Items section">
        ...
        <c:if test="${not readOnly}">
            <tr>
                ...
                <td class="infoline"><div align="center"><html:image property="methodToCall.insertItem" src="${pageContext.request.contextPath}/kr/images/tinybutton-add1.gif" alt="Insert an Item" title="Insert an Item" styleClass="tinybutton"/></div></td>
            </tr>
        </c:if>
        <logic:iterate id="item" name="KualiForm" property="document.items" indexId="ctr">
            <tr>
                ...
                <c:if test="${not readOnly}">
                    <td class="datacell"><div align="center"><html:image property="methodToCall.deleteItem.line${ctr}" src="${pageContext.request.contextPath}/kr/images/tinybutton-delete1.gif" title="Delete Item ${ctr+1}" alt="Delete Item ${ctr+1}" styleClass="tinybutton"/></div></td>
                </c:if>
            </tr>
        </logic:iterate>
		<tr>
