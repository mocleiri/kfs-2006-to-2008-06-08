...
ALTER TABLE LD_BCN_BUILD_EXSALTOT01_MT ADD CONSTRAINT LD_BCN_BUILD_EXSALTOT01_MTP1 PRIMARY KEY (
        ...
        emplid)
/
ALTER TABLE LD_BCN_BUILD_EXSALTOT01_MT ADD CONSTRAINT LD_BCN_BUILD_EXSALTOT01_MTC0 UNIQUE (OBJ_ID)
/
ALTER TABLE LD_BCN_BUILD_EXSALTOT01_MT MODIFY (OBJ_ID DEFAULT SYS_GUID()); 
