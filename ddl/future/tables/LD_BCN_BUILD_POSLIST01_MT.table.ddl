...
ALTER TABLE LD_BCN_BUILD_POSLIST01_MT ADD CONSTRAINT LD_BCN_BUILD_POSLIST01_MTP1 PRIMARY KEY (
        ...
        emplid)
/
ALTER TABLE LD_BCN_BUILD_POSLIST01_MT ADD CONSTRAINT LD_BCN_BUILD_POSLIST01_MTC0 UNIQUE (OBJ_ID)
/
ALTER TABLE LD_BCN_BUILD_POSLIST01_MT MODIFY (OBJ_ID DEFAULT SYS_GUID()); 
