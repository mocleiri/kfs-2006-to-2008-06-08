...
ALTER TABLE LD_BCN_DOC_PULLUP03_MT ADD CONSTRAINT LD_BCN_DOC_PULLUP03_MTP1 PRIMARY KEY (
        ...
        fdoc_nbr)
/
ALTER TABLE LD_BCN_DOC_PULLUP03_MT ADD CONSTRAINT LD_BCN_DOC_PULLUP03_MTC0 UNIQUE (OBJ_ID)
/
ALTER TABLE LD_BCN_DOC_PULLUP03_MT MODIFY (OBJ_ID DEFAULT SYS_GUID()); 
