...
ALTER TABLE LD_BCN_BUILD_SALTOT05_MT ADD CONSTRAINT LD_BCN_BUILD_SALTOT05_MTP1 PRIMARY KEY (
		...
		emplid)
/
ALTER TABLE LD_BCN_BUILD_SALTOT05_MT ADD CONSTRAINT LD_BCN_BUILD_SALTOT05_MTC0 UNIQUE (OBJ_ID)
/
ALTER TABLE LD_BCN_BUILD_SALTOT05_MT MODIFY (OBJ_ID DEFAULT SYS_GUID()); 
