...
CREATE TABLE LD_BCN_BUILD_CTRL_LIST02_MT(
        ...
        OBJ_ID                         VARCHAR2(36) DEFAULT SYS_GUID() CONSTRAINT LD_BCN_BUILD_CTRL_LIST02_MTN8 NOT NULL,
        VER_NBR                        NUMBER(8) DEFAULT 1 CONSTRAINT LD_BCN_BUILD_CTRL_LIST02_MTN9 NOT NULL,
     ...
     CONSTRAINT LD_BCN_BUILD_CTRL_LIST02_MTP1 PRIMARY KEY (
        ...
        ACCOUNT_NBR,
        SUB_ACCT_NBR),
     CONSTRAINT LD_BCN_BUILD_CTRL_LIST02_MTC0 UNIQUE (OBJ_ID)
)
/
