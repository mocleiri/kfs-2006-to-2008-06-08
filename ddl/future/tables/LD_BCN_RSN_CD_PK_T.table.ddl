...
CREATE TABLE LD_BCN_RSN_CD_PK_T(
        ...
        OBJ_ID                         VARCHAR2(36) DEFAULT SYS_GUID() CONSTRAINT LD_BCN_RSN_CD_PK_TN3 NOT NULL,
        VER_NBR                        NUMBER(8) DEFAULT 1 CONSTRAINT LD_BCN_RSN_CD_PK_TN4 NOT NULL,
        SELECT_FLAG                    NUMBER(7),
     CONSTRAINT LD_BCN_RSN_CD_PK_TP1 PRIMARY KEY (
        PERSON_UNVL_ID,
        APPT_FND_REASON_CD),
     CONSTRAINT LD_BCN_RSN_CD_PK_TC0 UNIQUE (OBJ_ID)
)
/
