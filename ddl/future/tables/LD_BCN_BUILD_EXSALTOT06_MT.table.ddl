...
AS
	...
	WHERE 1=2)
/
ALTER TABLE LD_BCN_BUILD_EXSALTOT06_MT ADD CONSTRAINT LD_BCN_BUILD_EXSALTOT06_MTP1 PRIMARY KEY (
        SESID,
		ORG_FIN_COA_CD,
		ORG_CD,
		emplid)
/
ALTER TABLE LD_BCN_BUILD_EXSALTOT06_MT ADD CONSTRAINT LD_BCN_BUILD_EXSALTOT06_MTC0 UNIQUE (OBJ_ID)
/
ALTER TABLE LD_BCN_BUILD_EXSALTOT06_MT MODIFY (OBJ_ID DEFAULT SYS_GUID()); 
ALTER TABLE LD_BCN_BUILD_EXSALTOT06_MT MODIFY (VER_NBR DEFAULT 1);
