...
ALTER TABLE LD_BCN_BUILD_MNTHSUMM02_MT ADD CONSTRAINT LD_BCN_BUILD_MNTHSUMM02_MTP1 PRIMARY KEY (
		...
		fin_sub_obj_cd)
/
ALTER TABLE LD_BCN_BUILD_MNTHSUMM02_MT ADD CONSTRAINT LD_BCN_BUILD_MNTHSUMM02_MTC0 UNIQUE (OBJ_ID)
/
ALTER TABLE LD_BCN_BUILD_MNTHSUMM02_MT MODIFY (OBJ_ID DEFAULT SYS_GUID()); 
