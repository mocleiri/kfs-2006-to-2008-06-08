...
ALTER TABLE LD_BCN_BUILD_PULLUP01_MT ADD CONSTRAINT LD_BCN_BUILD_PULLUP01_MTP1 PRIMARY KEY (
	    ...
	    org_cd)
/
ALTER TABLE LD_BCN_BUILD_PULLUP01_MT ADD CONSTRAINT LD_BCN_BUILD_PULLUP01_MTC0 UNIQUE (OBJ_ID)
/
ALTER TABLE LD_BCN_BUILD_PULLUP01_MT MODIFY (OBJ_ID DEFAULT SYS_GUID()); 
