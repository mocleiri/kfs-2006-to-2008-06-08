...
ALTER TABLE LD_BCN_UPDT_RQST02_MT ADD CONSTRAINT LD_BCN_UPDT_RQST02_MTP1 PRIMARY KEY (
		...
		fdoc_nbr)
/
ALTER TABLE LD_BCN_UPDT_RQST02_MT ADD CONSTRAINT LD_BCN_UPDT_RQST02_MTC0 UNIQUE (OBJ_ID)
/
ALTER TABLE LD_BCN_UPDT_RQST02_MT MODIFY (OBJ_ID DEFAULT SYS_GUID()); 
