...
ALTER TABLE LD_BCN_LCK_PYRT_ACCT01_MT ADD CONSTRAINT LD_BCN_LCK_PYRT_ACCT01_MTP1 PRIMARY KEY (
		...
		sub_acct_nbr)
/
ALTER TABLE LD_BCN_LCK_PYRT_ACCT01_MT ADD CONSTRAINT LD_BCN_LCK_PYRT_ACCT01_MTC0 UNIQUE (OBJ_ID)
/
ALTER TABLE LD_BCN_LCK_PYRT_ACCT01_MT MODIFY (OBJ_ID DEFAULT SYS_GUID()); 
