...
BEGIN
    ...
    FROM user_tables
    WHERE table_name = 'LD_BCN_BUILD_SALTOT03_MT';

	IF obj_count > 0 THEN
		EXECUTE IMMEDIATE('drop table LD_BCN_BUILD_SALTOT03_MT');
	END IF;
END;
/
...
ALTER TABLE LD_BCN_BUILD_SALTOT03_MT ADD CONSTRAINT LD_BCN_BUILD_SALTOT03_MTP1 PRIMARY KEY (
        ...
        emplid)
/
ALTER TABLE LD_BCN_BUILD_SALTOT03_MT ADD CONSTRAINT LD_BCN_BUILD_SALTOT03_MTC0 UNIQUE (OBJ_ID)
/
ALTER TABLE LD_BCN_BUILD_SALTOT03_MT MODIFY (OBJ_ID DEFAULT SYS_GUID()); 
