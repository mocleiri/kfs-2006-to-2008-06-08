...
CREATE TABLE LD_BCN_CTRL_LIST_T(
        ...
        OBJ_ID                         VARCHAR2(36) DEFAULT SYS_GUID() CONSTRAINT LD_BCN_CTRL_LIST_TN7 NOT NULL,
        VER_NBR                        NUMBER(8) DEFAULT 1 CONSTRAINT LD_BCN_CTRL_LIST_TN8 NOT NULL,
     ...
     CONSTRAINT LD_BCN_CTRL_LIST_TP1 PRIMARY KEY (
        ...
        ACCOUNT_NBR,
        SUB_ACCT_NBR),
     CONSTRAINT LD_BCN_CTRL_LIST_TC0 UNIQUE (OBJ_ID)
)
/
