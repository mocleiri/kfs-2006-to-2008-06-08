...
CREATE TABLE PUR_PO_RSTRC_MTRL_STATHST_T(
        ...
        OBJ_ID                         VARCHAR2(36) CONSTRAINT PUR_PO_RSTRC_MTRL_STATHST_TN2 NOT NULL,
        ...
        RSTRC_MTRL_STATHST_TS          DATE CONSTRAINT PUR_PO_RSTRC_MTRL_STATHST_TN7 NOT NULL,
        RSTRC_MTRL_STATHST_USR_ID      VARCHAR2(11) CONSTRAINT PUR_PO_RSTRC_MTRL_STATHST_TN8 NOT NULL,
