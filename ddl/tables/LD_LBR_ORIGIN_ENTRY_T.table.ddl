 ...
 */
CREATE TABLE LD_LBR_ORIGIN_ENTRY_T(
        ORIGIN_ENTRY_ID                NUMBER(14) CONSTRAINT LD_LBR_ORIGIN_ENTRY_TN1 NOT NULL,
        OBJ_ID                         VARCHAR2(36) DEFAULT SYS_GUID() CONSTRAINT LD_LBR_ORIGIN_ENTRY_TN2 NOT NULL,
        VER_NBR                        NUMBER(8) DEFAULT 1 CONSTRAINT LD_LBR_ORIGIN_ENTRY_TN3 NOT NULL,
        ORIGIN_ENTRY_GRP_ID            NUMBER(14) CONSTRAINT LD_LBR_ORIGIN_ENTRY_TN4 NOT NULL,
        ...
        SETID                          VARCHAR2(5),
        TIMESTAMP                      DATE,
     CONSTRAINT LD_LBR_ORIGIN_ENTRY_TP1 PRIMARY KEY (
        ORIGIN_ENTRY_ID),
     CONSTRAINT LD_LBR_ORIGIN_ENTRY_TC0 UNIQUE (OBJ_ID)
)
/
