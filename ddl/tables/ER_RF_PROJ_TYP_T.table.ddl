...
CREATE TABLE ER_RF_PROJ_TYP_T(
        ...
        OBJ_ID                         VARCHAR2(36) DEFAULT SYS_GUID() CONSTRAINT ER_RF_PROJ_TYP_TN3 NOT NULL,
        VER_NBR                        NUMBER(8,0) DEFAULT 1 CONSTRAINT ER_RF_PROJ_TYP_TN4 NOT NULL,
        PROJ_TYP_SEL_IND               VARCHAR2(1),
     CONSTRAINT ER_RF_PROJ_TYP_TP1 PRIMARY KEY (
        PROJ_TYP_CD,
        RDOC_NBR),
        CONSTRAINT ER_RF_PROJ_TYP_TC0 UNIQUE (OBJ_ID)
)
/
