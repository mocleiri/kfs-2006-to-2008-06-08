...
CREATE TABLE ER_GRAD_ASST_RT_T(
        ...
        LST_UPDT_TS                    DATE,
        DOBJ_MAINT_CD_ACTV_IND         VARCHAR2(1) CONSTRAINT ER_GRAD_ASST_RT_TN3 NOT NULL ENABLE,
     CONSTRAINT ER_GRAD_ASST_RT_TP1 PRIMARY KEY (
        CMP_CD),
     CONSTRAINT ER_GRAD_ASST_RT_TC0 UNIQUE (OBJ_ID)
)
/
