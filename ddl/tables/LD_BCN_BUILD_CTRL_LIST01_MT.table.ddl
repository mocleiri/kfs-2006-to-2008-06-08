...
BEGIN
    ...
    FROM user_tables
    WHERE table_name = 'LD_BCN_BUILD_CTRL_LIST01_MT';

	IF obj_count > 0 THEN
		EXECUTE IMMEDIATE('drop table LD_BCN_BUILD_CTRL_LIST01_MT');
	END IF;
END;
/
...
CREATE TABLE LD_BCN_BUILD_CTRL_LIST01_MT(
        ...
        VER_NBR                        NUMBER(8) DEFAULT 1 CONSTRAINT LD_BCN_BUILD_CTRL_LIST01_MTN6 NOT NULL,
