...
CREATE TABLE FP_ICR_ADJ_DOC_T(
        FDOC_NBR                       VARCHAR2(14) CONSTRAINT FP_ICR_ADJ_DOC_TN1 NOT NULL,
        OBJ_ID                         VARCHAR2(36) DEFAULT SYS_GUID() CONSTRAINT FP_ICR_ADJ_DOC_TN2 NOT NULL,
        VER_NBR                        NUMBER(8) DEFAULT 1 CONSTRAINT FP_ICR_ADJ_DOC_TN3 NOT NULL,
