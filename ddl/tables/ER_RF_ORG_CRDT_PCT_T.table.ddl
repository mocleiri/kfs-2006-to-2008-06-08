 ...
 */
CREATE TABLE ER_RF_ORG_CRDT_PCT_T(
        ...
        ORG_CRDT_ROLE_TXT              VARCHAR2(50),
     CONSTRAINT ER_RF_ORG_CRDT_PCT_TP1 PRIMARY KEY (
        RDOC_NBR,
        COA_CD,
        ORG_CD),
        CONSTRAINT ER_RF_ORG_CRDT_PCT_TC0 UNIQUE (OBJ_ID)
)
/
