CREATE TABLE CM_CPTLAST_DTL_T(
        FDOC_NBR                       VARCHAR2(14) CONSTRAINT CM_CPTLAST_DTL_TN1 NOT NULL,
        CPTLAST_NBR                    NUMBER(12) CONSTRAINT CM_CPTLAST_DTL_TN2 NOT NULL,
        OBJ_ID                         VARCHAR2(36) CONSTRAINT CM_CPTLAST_DTL_TN3 NOT NULL,
        VER_NBR                        NUMBER(8) DEFAULT 1 CONSTRAINT CM_CPTLAST_DTL_TN4 NOT NULL,
     ...
     CONSTRAINT CM_CPTLAST_DTL_TP1 PRIMARY KEY (
        FDOC_NBR,
        CPTLAST_NBR),
