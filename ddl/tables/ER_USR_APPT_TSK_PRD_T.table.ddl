...
CREATE TABLE ER_USR_APPT_TSK_PRD_T(
        ...
        BDGT_USR_SEQ_NBR               NUMBER(2,0) CONSTRAINT ER_USR_APPT_TSK_PRD_TN4 NOT NULL,
        INST_APPT_TYP_CD               VARCHAR2(2) CONSTRAINT ER_USR_APPT_TSK_PRD_TN5 NOT NULL,
        OBJ_ID                         VARCHAR2(36) DEFAULT SYS_GUID() CONSTRAINT ER_USR_APPT_TSK_PRD_TN6 NOT NULL,
