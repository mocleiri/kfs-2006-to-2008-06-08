...
CREATE TABLE CA_PRIOR_YR_ACCT_T(
        FIN_COA_CD                     VARCHAR2(2) CONSTRAINT CA_PRIOR_YR_ACCT_TN1 NOT NULL,
        ACCOUNT_NBR                    VARCHAR2(7) CONSTRAINT CA_PRIOR_YR_ACCT_TN2 NOT NULL,
        OBJ_ID                         VARCHAR2(36) DEFAULT SYS_GUID() CONSTRAINT CA_PRIOR_YR_ACCT_TN3 NOT NULL,
        VER_NBR                        NUMBER(8) DEFAULT 1 CONSTRAINT CA_PRIOR_YR_ACCT_TN4 NOT NULL,
