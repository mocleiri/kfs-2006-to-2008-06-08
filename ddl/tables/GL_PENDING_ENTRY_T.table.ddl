...
CREATE TABLE GL_PENDING_ENTRY_T(
        FS_ORIGIN_CD                   VARCHAR2(2) CONSTRAINT GL_PENDING_ENTRY_TN1 NOT NULL,
        FDOC_NBR                       VARCHAR2(14) CONSTRAINT GL_PENDING_ENTRY_TN2 NOT NULL,
        TRN_ENTR_SEQ_NBR               NUMBER(5) CONSTRAINT GL_PENDING_ENTRY_TN3 NOT NULL,
        OBJ_ID                         VARCHAR2(36) DEFAULT SYS_GUID() CONSTRAINT GL_PENDING_ENTRY_TN4 NOT NULL,
        VER_NBR                        NUMBER(8) DEFAULT 1 CONSTRAINT GL_PENDING_ENTRY_TN5 NOT NULL,
     ...
     CONSTRAINT GL_PENDING_ENTRY_TP1 PRIMARY KEY (
        FS_ORIGIN_CD,
        FDOC_NBR,
        TRN_ENTR_SEQ_NBR),
