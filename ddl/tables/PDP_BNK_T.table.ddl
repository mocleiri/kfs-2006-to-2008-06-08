CREATE TABLE PDP_BNK_T(
        BNK_RTNG_NBR                   VARCHAR2(9) CONSTRAINT PDP_BNK_TN1 NOT NULL,
        OBJ_ID                         VARCHAR2(36) DEFAULT SYS_GUID() CONSTRAINT PDP_BNK_TN2 NOT NULL,
        VER_NBR                        NUMBER(8) DEFAULT 1 CONSTRAINT PDP_BNK_TN3 NOT NULL,
     ...
     CONSTRAINT PDP_BNK_TP1 PRIMARY KEY (
        BNK_RTNG_NBR),
     CONSTRAINT PDP_BNK_TC0 UNIQUE (OBJ_ID)
)
/
