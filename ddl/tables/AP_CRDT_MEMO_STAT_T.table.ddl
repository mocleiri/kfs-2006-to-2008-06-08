...
CREATE TABLE AP_CRDT_MEMO_STAT_T(
        ...
        OBJ_ID                         VARCHAR2(36) DEFAULT SYS_GUID() CONSTRAINT AP_CRDT_MEMO_STAT_TN2 NOT NULL,
        ...
        DOBJ_MAINT_CD_ACTV_IND         VARCHAR2(1) CONSTRAINT AP_CRDT_MEMO_STAT_TN5 NOT NULL,
