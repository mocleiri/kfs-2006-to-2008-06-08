CREATE TABLE PDP_TRN_TYP_CD_T(
        ...
        OBJ_ID                         VARCHAR2(36) DEFAULT SYS_GUID() CONSTRAINT PDP_TRN_TYP_CD_TN2 NOT NULL,
        ...
        LST_UPDT_USR_ID                VARCHAR2(11) CONSTRAINT PDP_TRN_TYP_CD_TN5 NOT NULL,
     CONSTRAINT PDP_TRN_TYP_CD_TP1 PRIMARY KEY (
        TRN_TYP_CD),
     CONSTRAINT PDP_TRN_TYP_CD_TC0 UNIQUE (OBJ_ID)
)
/
