CREATE TABLE PUR_THRSHLD_T(
        PUR_THRSHLD_ID                 DECIMAL(10) CONSTRAINT PUR_THRSHLD_TN1 NOT NULL,
        ...
        ORG_CD                         VARCHAR2(4), 
        PUR_THRSHLD_AMT                DECIMAL(19), 
        VNDR_HDR_GNRTD_ID              DECIMAL(10), 
        VNDR_DTL_ASND_ID               DECIMAL(10), 
        PUR_COMM_CD                    VARCHAR2(40), 
        DOBJ_MAINT_CD_ACTV_IND         VARCHAR(1) CONSTRAINT PUR_THRSHLD_TN4 NOT NULL, 
