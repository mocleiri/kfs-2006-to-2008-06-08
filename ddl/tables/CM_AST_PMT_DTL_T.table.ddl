CREATE TABLE CM_AST_PMT_DTL_T(
        FDOC_NBR                       VARCHAR2(14) CONSTRAINT CM_AST_PMT_DTL_TN1 NOT NULL,
        FDOC_LINE_NBR                  NUMBER(7) CONSTRAINT CM_AST_PMT_DTL_TN2 NOT NULL,
        OBJ_ID                         VARCHAR2(36) CONSTRAINT CM_AST_PMT_DTL_TN3 NOT NULL,
        VER_NBR                        NUMBER(8) DEFAULT 1 CONSTRAINT CM_AST_PMT_DTL_TN4 NOT NULL,
     ...
     CONSTRAINT CM_AST_PMT_DTL_TP1 PRIMARY KEY (
        FDOC_NBR,
        FDOC_LINE_NBR),
