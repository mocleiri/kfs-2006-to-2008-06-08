...
CREATE TABLE ER_BDGT_DOC_T    (
        ...
        INST_CST_SHR_NXT_SEQ_NBR       NUMBER(2),
        THRD_PRTY_CST_SHR_NXT_SEQ_NBR  NUMBER(2), 
      CONSTRAINT ER_BDGT_DOC_TP1 PRIMARY KEY (
        FDOC_NBR),
      CONSTRAINT ER_BDGT_DOC_TC0 UNIQUE (OBJ_ID)
)
/
