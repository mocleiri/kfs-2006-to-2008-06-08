CREATE TABLE PUR_RCVNG_ADDR_T(
        ...
        OBJ_ID                         VARCHAR2(36) CONSTRAINT PUR_RCVNG_ADDR_TN2 NOT NULL,
        VER_NBR                        NUMBER(8) DEFAULT 1 CONSTRAINT PUR_RCVNG_ADDR_TN3 NOT NULL,
        FIN_COA_CD                     VARCHAR2(2) CONSTRAINT PUR_RCVNG_ADDR_TN4 NOT NULL, 
        ORG_CD                         VARCHAR2(4),
        ...
        DOBJ_MAINT_CD_ACTV_IND         VARCHAR2(1) CONSTRAINT PUR_RCVNG_ADDR_TN5 NOT NULL,
