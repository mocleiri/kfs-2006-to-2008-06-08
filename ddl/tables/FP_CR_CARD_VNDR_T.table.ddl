...
CREATE TABLE FP_CR_CARD_VNDR_T(
        FDOC_CCRD_VNDR_NBR             VARCHAR2(10) CONSTRAINT FP_CR_CARD_VNDR_TN1 NOT NULL,
        OBJ_ID                         VARCHAR2(36) DEFAULT SYS_GUID() CONSTRAINT FP_CR_CARD_VNDR_TN2 NOT NULL,
        VER_NBR                        NUMBER(8) DEFAULT 1 CONSTRAINT FP_CR_CARD_VNDR_TN3 NOT NULL,
     ...
     CONSTRAINT FP_CR_CARD_VNDR_TP1 PRIMARY KEY (
        FDOC_CCRD_VNDR_NBR),
