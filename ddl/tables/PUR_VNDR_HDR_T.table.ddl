...
CREATE TABLE PUR_VNDR_HDR_T(
        VNDR_HDR_GNRTD_ID              NUMBER(10) CONSTRAINT PUR_VNDR_HDR_TN1 NOT NULL,
        OBJ_ID                         VARCHAR2(36) CONSTRAINT PUR_VNDR_HDR_TN2 NOT NULL,
     ...
     CONSTRAINT PUR_VNDR_HDR_TP1 PRIMARY KEY (
        VNDR_HDR_GNRTD_ID),
