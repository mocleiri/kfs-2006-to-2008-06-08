...
CREATE TABLE CA_BDGT_AGGR_T(
        FOBJ_BDGT_AGGR_CD              VARCHAR2(1) CONSTRAINT CA_BDGT_AGGR_TN1 NOT NULL,
        OBJ_ID                         VARCHAR2(36) CONSTRAINT CA_BDGT_AGGR_TN2 NOT NULL,
        VER_NBR                        NUMBER(8) DEFAULT 1 CONSTRAINT CA_BDGT_AGGR_TN3 NOT NULL,
        DOBJ_MAINT_CD_ACTV_IND         VARCHAR2(1) CONSTRAINT CA_BDGT_AGGR_TN4 NOT NULL,
