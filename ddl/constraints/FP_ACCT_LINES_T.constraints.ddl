...
ADD (CONSTRAINT FP_ACCT_LINES_TR6 FOREIGN KEY (
      PROJECT_CD )
REFERENCES CA_PROJECT_T (
      PROJECT_CD ))
ADD (CONSTRAINT FP_ACCT_LINES_TR7 FOREIGN KEY (
      FIN_BALANCE_TYP_CD )
REFERENCES CA_BALANCE_TYPE_T (
      FIN_BALANCE_TYP_CD ))
ADD (CONSTRAINT FP_ACCT_LINES_TR8 FOREIGN KEY (
      FIN_OBJ_TYP_CD )
REFERENCES CA_OBJ_TYPE_T (
      FIN_OBJ_TYP_CD ))
ADD (CONSTRAINT FP_ACCT_LINES_TR9 FOREIGN KEY (
      FS_REF_ORIGIN_CD )
REFERENCES FS_ORIGIN_CODE_T (
      FS_ORIGIN_CD ))
ADD (CONSTRAINT FP_ACCT_LINES_TR10 FOREIGN KEY (
      FDOC_REF_TYP_CD )
