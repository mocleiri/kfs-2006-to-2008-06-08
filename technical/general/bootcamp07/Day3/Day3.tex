...
\begin{ifhtml}
    \begin{s5slide}
      ...
      \begin{enumerate}
        \item \xml{u}TransactionalDocument\xml{/u} Overview
        \item \xml{u}TransactionalDocument\xml{/u} Workshop
          \begin{itemize}
...
\end{ifhtml}  
  ...
  \input{Day3-TransactionalDocumentOverview.tex}
...
\end{ifhtml}
  ...
  \input{Day3-TransactionalDocumentWorkshop.tex}
  \input{Day3-Lookup.tex}
\begin{ifhtml}
  \begin{s5slide}
    \section{Lunch}
