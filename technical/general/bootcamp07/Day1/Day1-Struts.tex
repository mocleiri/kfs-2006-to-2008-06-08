\begin{ifhtml}
  \begin{s5slide}
    ...
    \begin{itemize}
      ...
      \item \code{WebApplicationInitListener} 
        and \code{JstlConstantsInitListener}
    \end{itemize}
  \end{s5slide}
...
\xml{pre style="color: blue"}\verb|<init-param>
  ...
  \begin{s5slide}
    ...
    \end{itemize}
    \begin{slideshow}
      \item \thumbnail{../Diagrams/PojoFormPopulate_Sequence.png}{../Diagrams/PojoFormPopulate_Sequence-thumb.png}
    \end{slideshow}
  ...
  \begin{s5slide}
      \section{\code{WebApplicationInitListener} \\
        and \code{JstlConstantsInitListener}}
    \begin{itemize}
