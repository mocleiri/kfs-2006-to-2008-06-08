...
/**
 * Abstraction for handling business rules of <code>{@link Document}</code>.
 * 
...
public interface DocumentProcessor {
    ...
    /**
     * Retrieves persistent <code>{@link Document}</code> object from <code>{@link DocumentProcessor}</code>.
     *
     * @return Document
     * @see Document
     */
    ...
    /**
     * Method for beginning processing of a <code>{@link Document}></code>
     *
     * @throws Throwable
     * @see Document
     */
