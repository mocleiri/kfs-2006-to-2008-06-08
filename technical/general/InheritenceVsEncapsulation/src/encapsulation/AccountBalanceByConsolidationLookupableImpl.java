 ...
 * 
 * $Source: /opt/cvs/kfs-documentation/technical/general/InheritenceVsEncapsulation/src/encapsulation/AccountBalanceByConsolidationLookupableImpl.java,v $
 * 
...
// ClassSignatureStartp
public class AccountBalanceByConsolidationLookupableImpl implements Lookupable, SearchableBy {
// ClassSignatureEnd
    ...
    public Method getSearchMethod() throws NoSuchMethodException, SecurityException {
        accountBalanceService.getClass().getMethod("findAccountBalanceByConsolidation",
                                                   Integer.class, String.class, String.class, 
                                                   String.class, boolean, boolean, int);
    }
    ...
    public List getSearchResults(Map fieldValues) {
        ...
        List results = getSearchResultsBy(getSearchMethod(), universityFiscalYear, chartOfAccountsCode, accountNumber, subAccountNumber, isCostShareExcluded, isConsolidated, pendingEntryCode);
