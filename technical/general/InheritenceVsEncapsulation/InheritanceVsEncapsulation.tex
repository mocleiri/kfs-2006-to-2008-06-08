...
\begin{document}
  ...
  \W \begin{s5slide}
    \begin{abstract}
      ...
      \begin{itemize}
        ...
        \item \href{http://en.wikipedia.org/wiki/Friday_the_13th}{April 13 is...}
        \item What went down on \href{http://en.wikipedia.org/wiki/April_13}{April 13}?
      \end{itemize}
      \end{ifhtml}
      \begin{tex}
  ...
  \W \begin{s5slide}
    ...
    \W \begin{s5slide}
      ...
      \begin{quote}
        For all things object-oriented, the conceptual framework is the \ObjectModel. Booch ~\cite{booch}
      \end{quote}
...
public abstract class AbstractGLLookupableImpl 
    ...
    ...
      ...
      \begin{quote}
        ...
        wherein a subclass specializes the more general structure or behavior of its superclasses. Booch \cite{booch}
      \end{quote}
      ...
      \begin{tex}
        ...
        \begin{quote}
          Object composition is an alternative to class inheritance. Here, new functionality is obtained by assembling or composing objects to get more complex
          functionality. Object composition requires that the objects being composed have well-defined interfaces. This style of reuse is called "black-box reuse," 
          because no internal details of objects are visible. Objects appear only as "black boxes." ``Gang of Four'' Page 19\cite{gangoffour}
        \end{quote}
      \end{tex}
  ...
  ``black-box'' reuse. (Gang of Four, 19)\cite{gangoffour}
  \end{tex}
  ...
  to explore the differences. Here are some basic bullet points.}
    ...
    \begin{tex}
      ...
      ``the internals of parent classes are often visible to subclasses.'' (Gang of Four, 18)\cite{gangoffour}
      ...
      \begin{quote}
        ...
        composition applied again and again in design-patterns. ``Gang of Four'' Page 20\cite{gangoffour}
      \end{quote}
      ...
      \begin{quote}
        ...
        composition thus work together. ``Gang of Four'' Page 20\cite{gangoffour}
      \end{quote}
  ...
  \W \begin{s5slide}
      ...
      \texonly{\texttt{abstract} classes have a foundation in \Inheritance, so what about them? Should they just not be used? Should we treat 
      them like some mistake in the Java language?}

      \T Well, \texttt{abstract} classes do have their uses.
  ...
  \W \begin{s5slide}
    ...
    \begin{tex}
      ...
      \begin{quote}
        ...
        the class names in one hierarchy are the same as the prefixes in another hierarchy. Fowler, Page 81 \cite{fowler}
      \end{quote}
      ...
      \begin{quote}
        ...
        \ldots you have an interface that is not a true reflection of what the class does. Fowler, Page 352 \cite{fowler}
      \end{quote}
      \begin{tex}
  ...
  \subsection{Examples of Parallel Hierarchies}
      ...
      \sf{ActionForm}\rm{} and a \sf{Action}\rm{} both need to be created. In an earlier section I describe how to merge the
        hierarchies using Fowler's ``Replace \Inheritance\ with Delegation'' (Fowler, 352)\cite refactoring and 
  ...
  \begin{tex}
    ...
    \bibitem{booch} Grady Booch. Object-Oriented Analysis and Design. Addison-Wesley, 2000.
    \bibitem{fowler} Martin Fowler, Kent Beck, John Brant, William Opdyke, Don Roberts. Refactoring: Improving the Design of Existing Code. Addison-Wesley, 2002.
    \bibitem{gangoffour} Eric Gamma, Richard Helm, Ralph Johnson, John Vlissides. Design Patterns: Elements of Reusable Object-Oriented Software. Addison-Wesley, 2002
    \end{thebibliography}
  \end{tex}
\end{document}