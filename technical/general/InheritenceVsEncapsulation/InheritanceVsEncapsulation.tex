...
public abstract class AbstractGLLookupableImpl 
  ...
  to explore the differences. Here are some basic bullet points.}
    ...
    \begin{tex}
      ...
      work together.
      \begin{quote}
        \dots the set of available components is never quite rich enough in practice. Reuse by inheritance 
  ...
  \W \begin{s5slide}
      ...
      \begin{quote}
        In this case, every time you make a subclass of one class, you also have to make a subclass of another\dots the prefixes of 
      ...
      \begin{quote}
        ...
        \dots you have an interface that is not a true reflection of what the class does.
      \end{quote}
