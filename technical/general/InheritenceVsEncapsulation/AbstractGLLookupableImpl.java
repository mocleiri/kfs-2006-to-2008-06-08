 ...
 * 
 */
public abstract class AbstractGLLookupableImpl extends KualiLookupableImpl {
// ClassSignatureEnd
     ...
     * @param isConsolidated flag whether the results are consolidated or not
     */
    public abstract void updateEntryCollection(Collection entryCollection, Map fieldValues, boolean isApproved, boolean isConsolidated, boolean isCostShareInclusive);
