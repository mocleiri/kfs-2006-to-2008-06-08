 ...
 */
public class PendingInvoice extends PersistableBusinessObjectBase {
	 ...
	 * 
	 */
	public PendingInvoiceItem getInvoice() { 
		return invoice;
	}
	 ...
	 * @deprecated
	 */
	public void setInvoice(PendingInvoiceItem invoice) {
		this.invoice = invoice;
	}

	/**
	 * Gets the lastAction attribute.
	 * 
	 * @return Returns the lastAction
	 * 
	 */
	public PendingAction getLastAction() { 
		return lastAction;
	}

	/**
	 * Sets the lastAction attribute.
	 * 
	 * @param lastAction The lastAction to set.
	 * @deprecated
	 */
	public void setLastAction(PendingAction lastAction) {
